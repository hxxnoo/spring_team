...
import com.spring.team.util.SettingValues;
...
public class CustomerDAOImpl implements CustomerDAO{
	...
	public int zipcodeInsert(Zipcode dto) {
		return SqlSession.getMapper(CustomerDAO.class).zipcodeInsert(dto);
	}

	@Override
	public int zipcodechk(String zipcode) {
		return SqlSession.getMapper(CustomerDAO.class).zipcodechk(zipcode);
	}
